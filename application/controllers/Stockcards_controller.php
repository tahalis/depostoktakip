...
class Stockcards_controller extends CI_Controller {
    ...
    public function add(){
        ...
        if($_arraydata['productname']=="" || $_arraydata['productname']==" " ||  $_arraydata['created_id']=="" ||!isset($_arraydata['productname']) || !isset($_arraydata['created_id'])) return "Bilgiler bos birakilamaz"; // istediğimiz bilgileri kontrol ediyoruz.
    ...
    public function update(){
        ...
        if($_updatearray['productname']=="" || $_updatearray['productname']==" " ||  $_updatearray['modified_id']=="" ||!isset($_updatearray['productname']) || !isset($_updatearray['modified_id'])) return "Bilgiler bos birakilamaz"; // istediğimiz bilgileri kontrol ediyoruz.
    ...
    public function delete(){
        ...
        if($_delarray['stockcard_id']=="" || $_delarray['stockcard_id']==" " ||  $_delarray['deleted_id']=="" ||!isset($_delarray['stockcard_id']) || !isset($_delarray['deleted_id'])) return "Bilgiler bos birakilamaz"; // istediğimiz bilgileri kontrol ediyoruz.
