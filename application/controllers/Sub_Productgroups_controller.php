...
class Sub_Productgroups_controller extends CI_Controller {
    ...
    public function add(){
        ...
        if($_arraydata['subproductgroup_name']=="" || $_arraydata['subproductgroup_name']==" " ||  $_arraydata['created_id']=="" ||!isset($_arraydata['subproductgroup_name']) || !isset($_arraydata['created_id'])) return "Bilgiler bos birakilamaz"; // istediğimiz bilgileri kontrol ediyoruz.
    ...
    public function update(){
        ...
        if($_updatearray['subproductgroup_name']=="" || $_updatearray['subproductgroup_name']==" " ||  $_updatearray['modified_id']=="" ||!isset($_updatearray['subproductgroup_name']) || !isset($_updatearray['modified_id'])) return "Bilgiler bos birakilamaz"; // istediğimiz bilgileri kontrol ediyoruz.
    ...
    public function delete(){
        ...
        if($_delarray['subproductgroup_id']=="" || $_delarray['subproductgroup_id']==" " ||  $_delarray['deleted_id']=="" ||!isset($_delarray['subproductgroup_id']) || !isset($_delarray['deleted_id'])) return "Bilgiler bos birakilamaz"; // istediğimiz bilgileri kontrol ediyoruz.
