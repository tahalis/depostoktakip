...
class Storage_controller extends CI_Controller {
    ...
    public function add(){
        ...
        if(!isset($_arraydata['stores_name']) || !isset($_arraydata['created_id'])) {echo "Bilgiler bos birakilamaz";die();} // istediğimiz bilgileri kontrol ediyoruz.
    ...
    public function update(){
        ...
        if(!isset($_updatearray['stores_id']) || !isset($_updatearray['stores_name']) || !isset($_updatearray['modified_id'])) {echo "Bilgiler bos birakilamaz";die();} // istediğimiz bilgileri kontrol ediyoruz.
    ...
    public function delete(){
        ...
        if(!isset($_delarray['stores_id']) || !isset($_delarray['deleted_id'])){ echo "Bilgiler bos birakilamaz"; die();}// istediğimiz bilgileri kontrol ediyoruz.
